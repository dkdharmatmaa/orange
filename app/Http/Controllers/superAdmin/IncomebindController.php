...
{
    public function index($assos_id,$branch_id){
        $data=Incomebind::where([['association_id',$assos_id],['branch_id',$branch_id]])->get()->groupBy('minmum_range')->toArray();
        return json_encode($data);
    }
    public function single_matrix($assos_id,$branch_id,$minmum_range,$maximum_range){
    ...
    public function store(Request $request,$assos_id,$branch_id){
    ...
    public function update(Request $request,$assos_id,$branch_id,$minmum_range,$maximum_range){
    ...
    public function delete($minmum_range,$assoc_id,$branch_id){
