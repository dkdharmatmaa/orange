...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    onSubmit: function onSubmit(evt) {
      evt.preventDefault();
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_0__["default"].put("/admin/upadte-detail", this.user_form).then(function (_ref) {
        var data = _ref.data;
    ...
    submitAssociation: function submitAssociation(evt) {
      evt.preventDefault();
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_0__["default"].put("/admin/update-association/".concat(this.id), this.association_form).then(function (_ref2) {
        var data = _ref2.data;
    ...
    submitPassword: function submitPassword(evt) {
      var _this = this;
      evt.preventDefault();
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_0__["default"].put("/admin/update-password", this.password_form).then(function (_ref3) {
        var data = _ref3.data;
    ...
    get_report: function get_report() {
      var _this2 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_0__["default"].get("/admin/admin-report").then(function (_ref4) {
        var data = _ref4.data;
...
var render = function render() {
  ...
  }), _vm._v(" "), _c("b-form-group")], 1), _vm._v(" "), _c("b-form-textarea", {
    staticClass: "ml-1 mb-5 input-box",
    attrs: {
      id: "textarea",
      required: "",
