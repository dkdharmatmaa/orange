...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    delete_matrix: function delete_matrix(minmum_range) {
      ...
      if (proceed) {
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_0__["default"]["delete"]("/admin/delete-matrix/".concat(minmum_range, "/").concat(this.branch_id)).then(function (_ref2) {
          var data = _ref2.data;
          _this3.get_plans();
        });
      }
