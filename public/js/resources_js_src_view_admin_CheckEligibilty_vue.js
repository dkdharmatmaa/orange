  ...
  methods: {
    onSubmit: function onSubmit(evt) {
      ...
      if (this.eligiblity_form.total_people == 'Number of people in household') {
        ...
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].post("/admin/check-eligibilty", this.eligiblity_form).then(function (_ref) {
          var data = _ref.data;
          _this.$router.push({
    ...
    getBranches: function getBranches() {
      var _this2 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].get("/admin/all-branch/").then(function (_ref2) {
        var data = _ref2.data;
        var branch_option = [];
        branch_option.push({
          value: '',
