...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    onSubmit: function onSubmit(evt) {
      evt.preventDefault();
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].put("/admin/edit-matrix/".concat(this.branch_id, "/").concat(this.search_minmum, "/").concat(this.search_maximum), this.single_arr).then(function (_ref) {
        var data = _ref.data;
    ...
    getData: function getData() {
      var _this = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].get("/admin/single-matrix/".concat(this.branch_id, "/").concat(this.search_minmum, "/").concat(this.search_maximum)).then(function (_ref2) {
        var data = _ref2.data;
