...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    onSubmit: function onSubmit(evt) {
      ...
      evt.preventDefault();
      if (this.action == 'Add') {
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].post("/admin/create-user", this.user_form).then(function (_ref) {
          var data = _ref.data;
        ...
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].put("/admin/edit-user/".concat(this.user_form.id), this.user_form).then(function (_ref2) {
          var data = _ref2.data;
    ...
    getData: function getData(id) {
      var _this2 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].get("/admin/all-user/".concat(id)).then(function (_ref3) {
        var data = _ref3.data;
    ...
    getBranches: function getBranches() {
      var _this3 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].get("/admin/all-branch").then(function (_ref4) {
        var data = _ref4.data;
        var branch_option = [];
        branch_option.push({
          value: "",
