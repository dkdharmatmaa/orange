...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    getBranches: function getBranches() {
      var _this = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].get("/user/all-branch").then(function (_ref) {
        var data = _ref.data;
        var branch_option = [];
        branch_option.push({
          value: null,
  ...
  computed: _objectSpread(_objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_2__.mapGetters)(["layoutConfig", "currentUser"])), (0,vuex__WEBPACK_IMPORTED_MODULE_2__.mapGetters)({
