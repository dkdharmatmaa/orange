...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    get_suggestion_keyword: function get_suggestion_keyword() {
      console.log("hello i am in function");
      axios__WEBPACK_IMPORTED_MODULE_3___default().get("http://suggestqueries.google.com/complete/search?client=chrome&q=payment+gateway+india").then(function (res) {
        console.log(res);
      });
    },
    onSubmit: function onSubmit(evt) {
      evt.preventDefault();
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].put("/user/upadte-detail", this.user_form).then(function (_ref) {
        var data = _ref.data;
    ...
    submitPassword: function submitPassword(evt) {
      var _this = this;
      evt.preventDefault();
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].put("/user/update-password", this.password_form).then(function (_ref2) {
        var data = _ref2.data;
    ...
    getBranch: function getBranch() {
      var _this2 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].get("/user/all-branch/".concat(this.branch_id)).then(function (_ref3) {
        var data = _ref3.data;
