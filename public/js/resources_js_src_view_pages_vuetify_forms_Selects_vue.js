...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/vuetify/forms/Selects.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/vuetify/forms/Selects.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/vuetify/forms/Selects.vue?vue&type=template&id=6c081f0a&":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/vuetify/forms/Selects.vue?vue&type=template&id=6c081f0a& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("div", [_c("b-alert", {
  ...
  }, [_c("b", [_vm._v("Selects")]), _vm._v(" Select fields components are used for collecting user\n      provided information from a list of options.\n      "), _c("a", {
    ...
    scopedSlots: _vm._u([{
      key: "preview",
      fn: function fn() {
        return [_c("p", [_vm._v("You cannot use disabled "), _c("code", [_vm._v("v-select")]), _vm._v(".")]), _vm._v(" "), _c("v-row", {
          attrs: {
            align: "center"
          }
        }, [_c("v-col", {
    ...
    scopedSlots: _vm._u([{
      key: "preview",
      fn: function fn() {
        return [_c("p", [_vm._v("\n            You cannot use read-only "), _c("code", [_vm._v("v-select")]), _vm._v(", but it looks\n            default.\n          ")]), _vm._v(" "), _c("v-row", {
          attrs: {
            align: "center"
          }
        }, [_c("v-col", {
    ...
    scopedSlots: _vm._u([{
      key: "preview",
      fn: function fn() {
        return [_c("p", [_vm._v("\n            You can use "), _c("code", [_vm._v("dense")]), _vm._v(" prop to reduce the field height and\n            lower max height of list items.\n          ")]), _vm._v(" "), _c("v-container", {
          attrs: {
            fluid: ""
          }
        }, [_c("v-row", {
    ...
    scopedSlots: _vm._u([{
      key: "preview",
      fn: function fn() {
        return [_c("p", [_vm._v("\n            The "), _c("code", [_vm._v("selection")]), _vm._v(" slot can be used to customize the way\n            selected values are shown in the input. This is great when you\n            want something like "), _c("code", [_vm._v("foo (+20 others)")]), _vm._v(" or don't want\n            the selection to occupy multiple lines.\n          ")]), _vm._v(" "), _c("v-container", {
          attrs: {
            fluid: ""
          }
        }, [_c("v-select", {
          ...
          scopedSlots: _vm._u([{
            ...
            fn: function fn(_ref) {
              var item = _ref.item,
                index = _ref.index;
              return [index === 0 ? _c("v-chip", [_c("span", [_vm._v(_vm._s(item))])]) : _vm._e(), _vm._v(" "), index === 1 ? _c("span", {
                staticClass: "grey--text caption"
              }, [_vm._v("(+" + _vm._s(_vm.code7.value.length - 1) + " others)")]) : _vm._e()];
            }
          }]),
          model: {
    ...
    scopedSlots: _vm._u([{
      key: "preview",
      fn: function fn() {
        return [_c("p", [_vm._v("Use a custom prepended or appended icon.")]), _vm._v(" "), _c("v-container", {
          attrs: {
            fluid: ""
          }
        }, [_c("v-row", {
        ...
        }, [_c("v-subheader", [_vm._v("Prepended icon")])], 1), _vm._v(" "), _c("v-col", {
          attrs: {
            cols: "6"
          }
        }, [_c("v-select", {
        ...
        }, [_c("v-subheader", [_vm._v("Appended icon")])], 1), _vm._v(" "), _c("v-col", {
          attrs: {
            cols: "6"
          }
        }, [_c("v-select", {
    ...
    scopedSlots: _vm._u([{
      key: "preview",
      fn: function fn() {
        return [_c("p", [_vm._v("\n            A multi-select can utilize "), _c("code", [_vm._v("v-chip")]), _vm._v(" as the display for\n            selected items.\n          ")]), _vm._v(" "), _c("v-container", {
          attrs: {
            fluid: ""
          }
        }, [_c("v-row", {
    ...
    scopedSlots: _vm._u([{
      key: "preview",
      fn: function fn() {
        return [_c("p", [_vm._v("\n            The "), _c("code", [_vm._v("v-select")]), _vm._v(" components can be optionally expanded\n            with prepended and appended items. This is perfect for customized\n            "), _c("strong", [_vm._v("select-all")]), _vm._v(" functionality.\n          ")]), _vm._v(" "), _c("v-container", {
          attrs: {
            fluid: ""
          }
        }, [_c("v-select", {
          ...
          scopedSlots: _vm._u([{
            ...
            fn: function fn() {
              return [_c("v-list-item", {
                ...
                attrs: {
                  color: _vm.code6.selectedFruits.length > 0 ? "indigo darken-4" : ""
                }
              }, [_vm._v(_vm._s(_vm.icon))])], 1), _vm._v(" "), _c("v-list-item-content", [_c("v-list-item-title", [_vm._v("Select All")])], 1)], 1), _vm._v(" "), _c("v-divider", {
                staticClass: "mt-2"
              })];
            },
            proxy: true
            ...
            fn: function fn() {
              ...
              }, [_c("v-icon", [_vm._v("mdi-food-apple")])], 1), _vm._v(" "), _vm.likesAllFruit ? _c("v-list-item-content", [_c("v-list-item-title", [_vm._v("Holy smokes, someone call the fruit\n                      police!")])], 1) : _vm.likesSomeFruit ? _c("v-list-item-content", [_c("v-list-item-title", [_vm._v("Fruit Count")]), _vm._v(" "), _c("v-list-item-subtitle", [_vm._v(_vm._s(_vm.code6.selectedFruits.length))])], 1) : _c("v-list-item-content", [_c("v-list-item-title", [_vm._v("\n                      How could you not like fruit?\n                    ")]), _vm._v(" "), _c("v-list-item-subtitle", [_vm._v("\n                      Go ahead, make a selection above!\n                    ")])], 1)], 1)];
            },
            proxy: true
          }]),
          model: {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Selects_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Selects.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/vuetify/forms/Selects.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Selects_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Selects_vue_vue_type_template_id_6c081f0a___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Selects_vue_vue_type_template_id_6c081f0a___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Selects_vue_vue_type_template_id_6c081f0a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Selects.vue?vue&type=template&id=6c081f0a& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/src/view/pages/vuetify/forms/Selects.vue?vue&type=template&id=6c081f0a&");
