...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  data: function data() {
    return {
      eligiblity_form: new (vform__WEBPACK_IMPORTED_MODULE_0___default())({
        id: "",
        first_name: "",
        last_name: "",
  ...
  methods: {
    onSubmit: function onSubmit(evt) {
      ...
      if (this.eligiblity_form.total_people == 'Number of people in household') {
        ...
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].post("/superadmin/check-eligibilty", this.eligiblity_form).then(function (_ref) {
          var data = _ref.data;
          _this.$router.push({
    ...
    getAssociation: function getAssociation() {
      ...
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].get("/superadmin/all-admin").then(function (_ref2) {
        var data = _ref2.data;
    ...
    getBranches: function getBranches() {
      ...
      if (this.eligiblity_form.association_id) {
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].get("/superadmin/all-branch/0/".concat(this.eligiblity_form.association_id)).then(function (_ref3) {
          var data = _ref3.data;
          var branch_option = [];
          branch_option.push({
            value: '',
