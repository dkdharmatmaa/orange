...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  data: function data() {
    return {
      ...
      admin_form: new (vform__WEBPACK_IMPORTED_MODULE_0___default())({
        name: '',
        email: '',
        password: ''
      }),
  ...
  methods: {
    onSubmit: function onSubmit(evt) {
      evt.preventDefault();
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].put("/superadmin/update-association/".concat(this.association_id), this.association_form).then(function (_ref) {
        var data = _ref.data;
    ...
    add_admin: function add_admin(evt) {
      var _this = this;
      evt.preventDefault();
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].post("/superadmin/indivedual-admin/".concat(this.association_id), this.admin_form).then(function (_ref2) {
        var data = _ref2.data;
    ...
    get_association_with_admin: function get_association_with_admin() {
      var _this2 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"].get("/superadmin/association-with-admin/".concat(this.association_id)).then(function (_ref3) {
        var data = _ref3.data;
    ...
    delete_admin: function delete_admin(id) {
      ...
      if (proceed) {
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_1__["default"]["delete"]("/superadmin/delete-admin/".concat(id), this.admin_form).then(function (_ref4) {
          var data = _ref4.data;
