...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    onSubmit: function onSubmit(evt) {
      ...
      evt.preventDefault();
      if (this.action == 'Add') {
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_0__["default"].post("/superadmin/create-branch", this.branch_form).then(function (_ref) {
          var data = _ref.data;
        ...
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_0__["default"].put("/superadmin/edit-branch/".concat(this.branch_form.id), this.branch_form).then(function (_ref2) {
          var data = _ref2.data;
