...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    onSubmit: function onSubmit(evt) {
      ...
      evt.preventDefault();
      if (this.action == 'Add') {
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_0__["default"].post("/superadmin/create-user", this.user_form).then(function (_ref) {
          var data = _ref.data;
        ...
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_0__["default"].put("/superadmin/edit-user/".concat(this.user_form.id), this.user_form).then(function (_ref2) {
          var data = _ref2.data;
    ...
    getAssociation: function getAssociation() {
      var _this3 = this;
      _core_services_api_service__WEBPACK_IMPORTED_MODULE_0__["default"].get("/superadmin/all-admin").then(function (_ref4) {
        var data = _ref4.data;
    ...
    getBranches: function getBranches() {
      ...
      if (this.user_form.association_id) {
        _core_services_api_service__WEBPACK_IMPORTED_MODULE_0__["default"].get("/superadmin/all-branch/0/".concat(this.user_form.association_id)).then(function (_ref5) {
          var data = _ref5.data;
          var branch_option = [];
          branch_option.push({
            value: "",
