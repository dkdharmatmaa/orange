    ...
    <b-form @submit="onSubmit" class="w-md-50 fw-700">
      ...
      <div class="bg-white p-10 mt-5 rounded">
        ...
        <div class="alert alert-success mt-3" role="alert" id="fade">
         ...
         <div class="w-lg-25 w-md-50"><button  class="btn font-weight-bolder font-size-h6 py-3 w-100 bg-primary-color text-white mt-3 text-nowrap" style="border-radius: 20px;">{{action}} product</button></div>
      </div>
    </b-form>
  </div>
</template>
