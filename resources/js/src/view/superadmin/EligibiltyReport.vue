  ...
  <div class="mt-5">
    <div class="d-flex ml-2 justify-content-between">
          ...
          <b-form-group class="ml-3">
            <b-form-select id="input-3" v-model="condition_arr.association_id" :options="options_association" @change="getBranches(); get_report()" class="input-box text-seconday" required></b-form-select>
          </b-form-group>
          <b-form-group class="ml-3">
            <b-form-select id="input-4" v-model="condition_arr.branch_id" :options="options_branch" @change="get_report()" class="input-box text-seconday" required></b-form-select>
          </b-form-group>
          <b-form-group class="ml-3">
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {label:'No. of people',field:'no_of_people'},
  ...
  methods: {
    get_report(){
      ...
      ApiService.post("/superadmin/eligibilty-report",this.condition_arr)
        .then(({ data }) => {
          this.items=data;
